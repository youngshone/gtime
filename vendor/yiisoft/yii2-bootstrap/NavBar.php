...
class NavBar extends Widget
{
     ...
     *
     * @var type string
     * logo picture of the h5 site
     */
    public $brandImgUrl_m = false;
    /**
     *
     * @var type string
     * logo picture of the pc site
     */
    public $brandImgUrl_p = false;
    /**
    ...
    public function init()
    {
        ...
        if ($this->brandImgUrl_m !== false) {
            Html::addCssClass($this->brandOptions, ['widget' => 'navbar-brand']);
            echo Html::img($this->brandImgUrl_m);
        }
